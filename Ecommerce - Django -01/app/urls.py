...
admin.site.site_header = "Panel de Administración  Javier Brega"
admin.site.site_title = "Javier Brega"
admin.site.site_index_title = "Bienvenido al panel de administración de Javier Brega"
